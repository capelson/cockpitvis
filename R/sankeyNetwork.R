...
sankeyNetwork <- function(Links, Nodes, Source, Target, Value,
                          ...
                          height = NULL, width = NULL, iterations = 32, sinksRight = TRUE, stage_names = NULL, cost_activities = NULL)
{
  ...
  options = list(NodeID = NodeID, NodeGroup = NodeGroup, LinkGroup = LinkGroup,
                 ...
                 stage_names = stage_names, cost_activities = cost_activities)
